...
public class Utilidades {
    ...
    public static Object getData(Object clas, String attribte) throws InvocationTargetException, IllegalAccessException {
        ...
        Object obj = null;
        if (f != null) {
            String auxAtributte = "get" + capitalize(attribte);
            Method method = null;
            for (Method m : clazz.getMethods()) {
                if (m.getName().equalsIgnoreCase(auxAtributte)) {
                    method = m;
                    break;
                }
            }
    ...
    public static void abrirNavegadorWindowsDeterminado(String url) throws Exception {
